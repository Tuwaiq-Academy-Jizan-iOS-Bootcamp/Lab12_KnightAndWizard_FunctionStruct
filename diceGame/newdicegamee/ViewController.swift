...
//  newdicegamee
//
//  Created by Ehab Hakami on 18/03/1443 AH.
//
...
class ViewController: UIViewController {
    ...
    var turn: Int = 0
    var winner = false
    var ehab = ["face1","face2","face3","face4","face5","face6"]
    ...
    func logicOfTheGame() {
        ...
        labelVa.text = "LivePouint lazarus: \(lazarus.lifePoint)======LivePouint elvin:\(elvin.lifePoint)"
