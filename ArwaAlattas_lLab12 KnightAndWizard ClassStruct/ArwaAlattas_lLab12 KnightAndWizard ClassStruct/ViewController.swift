...
class ViewController: UIViewController {
    ...
    @IBAction func rollTheDice(_ sender: UIButton) {
        ...
        let stick = Weapon.init(name: "Stick of the wise", damage: 15, attackAction:"stick of the wise inficting 15 ")
        let fireBall = Power.init(name: "Fire Ball", damage: 20, attackAction: "fire ball inficting 20 ", specialEffect: 10)
        print("life point for Lazaruse in start  is \(lazarus.lifePoint)  ")
        print("life point for Elvin in start is \(elvin.lifePoint)")
