...
//  NouraAlnami12
//
//  Created by NoON .. on 16/03/1443 AH.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        while lazarus.lifePoints > got && elvin.lifePoints > got {
                     ...
                     if rollDice == 1 {
                         ...
                         print("Elvin have \(elvin.lifePoints) Life Points remain")
                     }else if rollDice == 3 {
                         ...
                         print("Lazarus have \(lazarus.lifePoints) Life Points")
                                      ...
                                      print("Elvin have \(elvin.lifePoints) Life Points")
                                  }else if rollDice == 5 {
